            ...
            Column {
                Card (
                    ...
                    Column (modifier = Modifier.padding(20.dp), horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        CaixadeEntrada(placeHolder = "Digite um nome de usuário", keyboardType = KeyboardType.Text)
                        Spacer(modifier = Modifier.height(16.dp))
                        CaixadeEntrada(placeHolder = "Digite um e-mail", keyboardType = KeyboardType.Email)
                        Spacer(modifier = Modifier.height(16.dp))
                        CaixadeEntrada(placeHolder = "Digite sua senha", keyboardType = KeyboardType.Password)
                        Spacer(modifier = Modifier.height(16.dp))
                        CaixadeEntrada( placeHolder = "Confirme sua senha", keyboardType = KeyboardType.Password)
                        Spacer(modifier = Modifier.height(16.dp))
